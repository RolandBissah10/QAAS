...
public class CrawlerServiceImpl implements CrawlerService {
    ...
    @Override
    public List<PageInfo> crawl(String baseUrl, CrawlOptions options) {
        ...
        try (Playwright pw = Playwright.create()) {
            ...
            // Authenticate before crawling if credentials are configured
            if (options.hasAuth()) {
                    ...
                    for (String href : hrefs) {
                        ...
                        try {
                            ...
                            String normalized = u.getScheme() + "://" + u.getHost()
                                    ...
                                    + (u.getPath() == null || u.getPath().isBlank() ? "/" : u.getPath());
